...
<template>
  <header class="py-3 mb-3 border-bottom bg-dark text-white">
    <div class="container">
      ...
      >
        <span
          class="d-flex align-items-center mb-2 me-2 mb-lg-0 text-white text-decoration-none fs-3"
        >
        ...
        <div class="dropdown text-end" v-if="user">
          <a
            href="#"
            class="d-block link-secondary text-decoration-none dropdown-toggle"
            id="dropdownUser1"
  ...
  <div class="container-fluid signin" м-удыу>
